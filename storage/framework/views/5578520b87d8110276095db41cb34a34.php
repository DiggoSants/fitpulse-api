    ...
    <div class="nav-auth">
      <?php if(Route::has('login')): ?>
        <?php if(auth()->guard()->check()): ?>
          <a href="<?php echo e(url('/dashboard')); ?>" class="cta--solid">DASHBOARD</a>
        <?php else: ?>
          <a href="<?php echo e(route('login')); ?>" class="cta--outline">LOGIN</a>
          <?php if(Route::has('register')): ?>
            <a href="<?php echo e(route('register')); ?>" class="cta--solid">REGISTRAR</a>
          <?php endif; ?>
        <?php endif; ?>
      <?php endif; ?>
  ...
  <section class="hero hero--porão" id="topo">
    <div class="container hero-layout">
      ...
      <div class="hero-media">
        <img class="hero-character" src="<?php echo e(asset('img/foto_inicial.png')); ?>" alt="Pessoa levantando peso">
      </div>
    </div>
  </section>
  ...
  <section class="about" id="sobre">
    <div class="container about-grid">
      <div class="about-media">
        ...
        <img class="about-img-main" src="<?php echo e(asset('img\Fit couple standing.jpg')); ?>" alt="Pessoas treinando">
        <button class="about-video" type="button" id="openVideo"
                data-video="<?php echo e(asset('video/video.mp4')); ?>">
...
<section class="section sedes-section" id="sedes">
  <div class="container">
    ...
    <div class="sedes-grid">
      ...
      <article class="sede-card">
        <div class="sede-card__img-wrap">
          <img src="<?php echo e(asset('img/sede5.jpg')); ?>" alt="Unidade Caucaia" loading="lazy">
      ...
      <!-- SEDE 6 -->
        <article class="sede-card">
          <div class="sede-card__img-wrap">
           <img src="<?php echo e(asset('img/sede6.jpg')); ?>" alt="Unidade Lagamar" loading="lazy">
...
</html><?php /**PATH C:\xampp\htdocs\fitpulse-api\fitpulse-api\resources\views/welcome.blade.php ENDPATH**/ ?>