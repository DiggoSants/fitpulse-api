        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('dashboard')); ?>" style="text-decoration:none; color:#fff; line-height:1;">
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1" style="border-top:1px solid rgba(255,255,255,0.08);">
            <div class="px-4">
                <div style="font-weight:700; font-size:14px; color:#fff;"><?php echo e(Auth::user()->name); ?></div>
                <div style="font-size:12px; color:rgba(255,255,255,0.4); margin-top:2px;"><?php echo e(Auth::user()->email); ?></div>
            </div>
...
</nav><?php /**PATH C:\xampp\htdocs\fitpulse-api\fitpulse-api\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>